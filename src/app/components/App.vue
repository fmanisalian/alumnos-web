        ...
        <div class="col-md-5">
         <!-- 
          <div class="card">
            <fieldset>
              <legend>
                Si desea buscar un alumno, marque la casilla siguiente:
              </legend>
            ...
            <div class="card-body">
              <form @submit.prevent="sendAlumno">
                ...
                <div class="form-group">
                  <span v-if="!alumno.dni" class="badge badge-warning"
                    >Ingresa el DNI del Alumno*</span
                  >
                  <input
                    type="text"
                    v-model="alumno.dni"
                    class="form-control"
                    placeholder="Inserte el DNI del Alumno"
                  />
                </div>
              -->
                ...
                <div class="form-group">
                  <fieldset>
                    <span v-if="!alumno.ingresa" class="badge badge-warning"
                      >Requerido*</span
                    >
                    <legend>Elige una de las dos opciones:</legend>
                    <input
                      type="radio"
                      v-model="alumno.ingresa"
                      id="i"
                      name="ingresaOegresa"
                      value="false"
                      picked
                ...
                <div class="form-group">
                  <span
                    v-if="!alumno.cursoPertenece"
                    class="badge badge-warning"
                    >Requerido*</span
                  >
                  <span
                    >Curso Seleccionado:
                    {{ (seleccionado = alumno.cursoPertenece) }}</span
                  >
                  <select
                    v-model="alumno.cursoPertenece"
                    class="form-control"
                ...
                <div class="form-group">
                  <span v-if="!alumno.apellido" class="badge badge-warning"
                    >Requerido*</span
                  >
                  <input
                    type="text"
                    ...
                    class="form-control"
                    placeholder="Inserte los Apellidos del Alumno"
                  />
                </div>
                <div class="form-group">
                  <span v-if="!alumno.nombre" class="badge badge-warning"
                    >Requerido*</span
                  >
                  <input
                    type="text"
                    ...
                    class="form-control"
                    placeholder="Inserte los Nombres del Alumno"
                  />
                </div>
                <div class="form-group">
                  <span v-if="!alumno.dni" class="badge badge-warning"
                ...
                <div class="form-group">
                  <span v-if="!alumno.colegio" class="badge badge-warning"
                    >Requerido*</span
                  >
                  <textarea
                    v-model="alumno.colegio"
                    cols="30"
                    rows="2"
                    placeholder="Inserte el número y nombre del otro Colegio"
                    class="form-control"
                  ></textarea>
                </div>
                <div class="form-group">
            ...
            >
              ...
              <tbody>
                <tr
                  ...
                  v-for="alumno in paginated('alumnos')"
                >
